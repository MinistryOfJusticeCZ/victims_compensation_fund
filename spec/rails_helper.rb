...
require 'egov_utils/test_utils/controller_helpers'
...
RSpec.configure do |config|
  ...
  config.before(type: :controller) do
    stub_request(:get, "love.justice.cz/api/v1/organizations.json?f%5Bcategory_abbrev%5D==%7COS%5CKS&sort%5B0%5D%5Bpath%5D=category_abbrev").
