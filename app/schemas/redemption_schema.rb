class RedemptionSchema < AzaharaSchema::ModelSchema
  ...
  filter_operators 'debt-offender-fullname', ['~']
  ...
  def enabled_filters
    ['debt-claim_id', 'debt-claim-file_uid', 'debt-offender-fullname', 'victim-fullname']
  end

  def always_visible_filters
    ['debt-claim-file_uid', 'debt-offender-fullname', 'victim-fullname']
  end
